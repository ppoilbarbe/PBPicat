...
- **Keyboard shortcuts F9 / F10** for "Apply EXIF orientation" and "Reset EXIF orientation", previously accessible only via menu/toolbar. Follows the existing F6/F7/F8 rotation shortcut sequence.
